...
The following Cloudflare API credentials are validated using a CRC32 checksum. Only credentials generated after Cloudflare's token format update will be matched by these entries.
