...
If you build from a template, the resulting sensitivity schema becomes your own object and can be edited after creation.
...
If you build from a template, the resulting data tag group becomes your own object and can be edited after creation.
