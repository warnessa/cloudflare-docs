...
In summary, DLP profiles are best for enforcement. Data Classification is best for organizing and labeling sensitive content in a reusable way before that logic is applied in DLP workflows.

## Next steps

To get started:

- [Configure labels and templates](/cloudflare-one/data-loss-prevention/data-classification/configure-labels-and-templates/)
- [Build a data class](/cloudflare-one/data-loss-prevention/data-classification/build-a-data-class/)
- [Configure DLP profiles](/cloudflare-one/data-loss-prevention/dlp-profiles/)
