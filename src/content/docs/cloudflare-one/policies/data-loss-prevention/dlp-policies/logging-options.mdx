...
1. In [Zero Trust](https://one.dash.cloudflare.com/), go to **Logs** > **Logpush**. Select **Create a Logpush job**.
2. Select a [Logpush destination](/logs/get-started/enable-destinations/) then configure the job to use the **DLP Forensic Copies** dataset.
